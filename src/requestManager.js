...
function convertBinanceData(data) {
...
function requestManager() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("https://api2.binance.com/api/v3/ticker/24hr")];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    data = _a.sent();
                    return [2 /*return*/, convertBinanceData(data)];
            }
        });
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, requestManager()];
                case 1:
                    binanceData = _a.sent();
                    return [2 /*return*/, binanceData];
            }
        });
    });
}
